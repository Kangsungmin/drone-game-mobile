...
public class DroneMovementScript: MonoBehaviour{
	...
	private void Animations(){
		if(animatedGameObject != null){
			...
			if(Input.GetKeyDown(barrelRollLeft)){
				StartCoroutine("Twirl_left_Method");
			}
			if(Input.GetKeyDown(barrelRollRight)){
				StartCoroutine("Twirl_right_Method");
			}
			animatedGameObject.SetBool("left_passage", Input.GetKey(swingLeft));
			animatedGameObject.SetBool("right_passage", Input.GetKey(swingRight));
		}
	}
	...
	public KeyCode barrelRollLeft = KeyCode.U;
	public KeyCode swingLeft = KeyCode.Q;
	public KeyCode swingRight = KeyCode.E;
